...
/**
 * Type definition for the Banner component props
 */
...
/**
 * Type definition for movie/series data structure
 */
interface MediaData {
	id: number;
	title?: string;
...
/**
 * Type definition for Redux state structure
 */
...
/**
 * Type for Redux selectors
 */
type MediaSelector = (state: any) => MediaState;
